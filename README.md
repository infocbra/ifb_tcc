# Template LaTeX para Trabalho de Conclusão de Curso do IFB - Campus Brasília, TSI
...
2. [Manual do abnTeX2cite](https://linorg.usp.br/CTAN/macros/latex/contrib/abntex2/doc/abntex2cite.pdf): Guia para citações no formato ABNT.
3. [Manual do abnTeX2cite-alf](https://br.mirrors.cicku.me/ctan/macros/latex/contrib/abntex2/doc/abntex2cite-alf.pdf): Guia específico para citações alfanuméricas no formato ABNT.

Esses materiais oferecem orientações detalhadas para o uso avançado do pacote e personalizações específicas.
