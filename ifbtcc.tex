...
%%          Alberth Santana Costa da Silva (1031270@etfbsb.edu.br)
%%
...
\documentclass[en,twoside,onehalfspacing,bsc]{ifbthesis}
...
\renewcommand*{\lstlistlistingname}{NewListing}
...
\author{Rafael de Campos Passos}
\adviser{Fabiano Cavalcanti Fernandes}
\coadviser{Cerqueira Cavalcanti}
